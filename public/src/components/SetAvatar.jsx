...
const Container = styled.div`
  ...
  .avatars {
    ...
    .avatar {
      ...
      background: #1a1a20; /* Dark Slate backing for avatars */
    ...
    .selected {
      border: 0.4rem solid #9d4edd; /* Electric Violet Border */
      box-shadow: 0 0 25px rgba(157, 78, 221, 0.6); /* Neon Glow */
      transform: scale(1.1);
    }
  }
  ...
  @media (max-width: 720px) {
      .avatars { gap: 1rem; flex-wrap: wrap; justify-content: center; }
      .title-container h1 { font-size: 1.5rem; padding: 0 1rem; }
  }
`;